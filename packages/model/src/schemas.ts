...
export const schemas = [Architecture, Domain, Ecosystem, GovernanceArtifact, GovernanceArtifactType, GovernanceEpisode, GovernanceEpisodeType, GovernanceEvent, GovernanceEventType, InstitutionalLayer, Organization, OrganizationRole, OrganizationRoleName, Person, PersonRole, PersonRoleName, Project] as const;

...
| Property                | Title                       | Type             | Required | Range                                             | Formula                                                                                                                                                                                                                                                                               | Description                                                                                              |
| :---------------------- | :-------------------------- | :--------------- | :------: | :------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------------- |
| `couplingLoad`          | Coupling Load               | number           |    No    | —                                                 | `n * (1 + h_d) * (1 + h_l)`                                                                                                                                                                                                                                                           | Composite measure of scale and structural heterogeneity of governance coordination demands.              |
| `description`           | description                 | string           |    No    | —                                                 | —                                                                                                                                                                                                                                                                                     |                                                                                                          |
| `domainHeterogeneity`   | Domain Heterogeneity        | number           |    No    | —                                                 | `1 - sum(values(D) .^ 2) / sum(values(D)) ^ 2`                                                                                                                                                                                                                                        | Simpson-style diversity index measuring how evenly partners are distributed across domains.              |
...
| `layerHeterogeneity`    | Layer Heterogeneity         | number           |    No    | —                                                 | `1 - sum(values(L) .^ 2) / sum(values(L)) ^ 2`                                                                                                                                                                                                                                        | Simpson-style diversity index measuring how evenly partners are distributed across institutional layers. |
| `name`                  | name                        | string           |    No    | —                                                 | —                                                                                                                                                                                                                                                                                     |                                                                                                          |
| `normalizedBurden`      | Normalized Burden           | number           |    No    | —                                                 | `tau_2 / c`                                                                                                                                                                                                                                                                           | Time to delivered value per unit of coupling load.                                                       |
| `partnerCount`          | Partner Count               | integer          |    No    | —                                                 | —                                                                                                                                                                                                                                                                                     | Number of governance-relevant institutional actors in this episode.                                      |
| `project`               | Project                     | string           |    Yes   | [Project](#project)                               | —                                                                                                                                                                                                                                                                                     | The project this episode belongs to.                                                                     |
| `stall`                 | Stall                       | boolean          |    No    | —                                                 | —                                                                                                                                                                                                                                                                                     | Whether the episode shows sustained governance engagement but no qualifying durable authorization.       |
...
| `episodeCount`         | Episode Count           | integer          |    No    | —                                        | —                                                                                                                                                      | Number of governance episodes in this project.                                                     |
| `name`                 | Name                    | string           |    Yes   | —                                        | —                                                                                                                                                      | Human-readable name.                                                                               |
| `normalizedBurden`     | Normalized Burden       | number           |    No    | —                                        | —                                                                                                                                                      | Project time to delivered value per unit of delivery-episode coupling load.                        |
| `partnerCount`         | Partner Count           | integer          |    No    | —                                        | —                                                                                                                                                      | Number of institutional actors contributing data in the delivery episode.                          |
| `stallFraction`        | Stall Fraction          | number           |    No    | —                                        | —                                                                                                                                                      | Proportion of episodes in the project that stalled.                                                |
| `stewardPresence`      | Steward Presence        | boolean          |    No    | —                                        | —                                                                                                                                                      | Whether the project includes an authorized domain representative who mediates governance requests. |
| `t0`                   | Project Start           | date \| datetime |    No    | —                                        | `min(map(E, f(e) = e.t0))`                                                                                                                             | The earliest episode initiation timestamp across all episodes in the project.                      |
| `t2`                   | First Delivered Value   | date \| datetime |    No    | —                                        | `min(map(filter(E, f(e) = equalText(e.governanceEpisodeType, "https://purl.dataecosystems.org/wpg/cbox#ProductGovernanceEpisodeType")), f(e) = e.t2))` | Timestamp of earliest analytic output answering a stakeholder question.                            |
| `tau2`                 | Time to Delivered Value | number           |    No    | —                                        | `t_2 - t_0`                                                                                                                                            | Calendar days from the earliest episode initiation to delivery of the first analytic output.       |
